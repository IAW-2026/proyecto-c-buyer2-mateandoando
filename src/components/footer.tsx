        ...
        <footer className="w-full mt-auto py-8 bg-surface-container-high border-t border-outline-variant">
            <div className="max-w-7xl mx-auto px-10 max-md:px-4 flex flex-col md:flex-row justify-between items-center gap-6">
                ...
                <div className="flex flex-wrap justify-center gap-6">
                    <Link href="/categorias" className="text-on-surface-variant hover:text-secondary transition-colors text-label-sm font-label-sm">Categorías</Link>
                    <Link href="/vendedores" className="text-on-surface-variant hover:text-secondary transition-colors text-label-sm font-label-sm">Vendedores</Link>
                </div>
            </div>
        </footer>
    )
